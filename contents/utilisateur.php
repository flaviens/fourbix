				...
				<?php
					...
					foreach ($mesBinets as $binet) {
						...
						if ($binet['binet'] != 'Administrateurs')
							echo "<form style='display: inline-block; margin-right: 5px; margin-bottom: 5px;' action='index.php?page=binet' method='post'><button type='submit' class='btn btn-primary' value='" . htmlspecialchars($binet['binet']) . "' name='pageBinet'><span class='glyphicon glyphicon-new-window'></span> Voir la page</button></form>";
						else
